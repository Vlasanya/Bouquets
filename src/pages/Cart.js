...
function Cart () {
  ...
  const groupBouquets = Object.keys(items).map((key) => {
    return items[key].items[0];
  });

  const onClearCart = () => {
   if(window.confirm('Are you sure to clean the cart?')){
    dispatch(clearCart());
   }
  }
          ...
          <div className="container container--cart">
            {
              ...
              <div className="cart__bottom">
                <div className="cart__bottom-details">
                  <span> Total bouquets: <b>{totalCount} pcs.</b> </span>
